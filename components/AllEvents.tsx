  ...
  return (
    <div className=" text-[#402B1A] bg-[#F3E8D8]">
      <div className="flex flex-row items-baseline justify-between  ">
        <h2 className="text-[4vw] font-goudy">
          ...
          {Array.from(
            ...
            return (
              <div
                ...
                className={`rounded-full border items-center flex flex-row font-mont font-semibold py-[0.5vh] px-[1.5vw] cursor-pointer ${
                  year === selectedYear
                    ? "bg-[#402B1A] text-[#F3E8D8] text-[2vh]"
                    : "border-[#402B1A] text-[2vh]"
                }`}
              >
                {year}
              </div>
      ...
      <div className="flex flex-col gap-[1vw]">
        {months.map((month) => {
          ...
          return (
            <div key={month} className="rounded w-full flex flex-col gap-[1vw]">
              <h3 className="text-[1.75vw] font-medium">
              ...
              {monthEvents.map((event) => {
                ...
                return (
                  <Link
                    ...
                    key={event._id}
                    className="rounded w-full hover:text-[#F3E8D8] hover:bg-[#402B1A] border-[0.3vh] border-[#402B1A] p-[1.5vw]"
                  >
                    <div className="flex flex-row items-center gap-[1vw]">
                      <div className="flex flex-col gap-[0vw] items-center w-[6vw] pl-[1.5vw]">
                        <p className="text-[4vw]">{date.getDate()}</p>
                        <p className="text-[1vw] font-medium font-mont">
                          {getDayOfWeek(date)}
                        </p>
                      </div>
